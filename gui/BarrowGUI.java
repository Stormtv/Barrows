...
public class BarrowGUI extends JFrame {
	...
	private static JCheckBox DharokPrayer, DharokPotions, KarilPrayer,
			KarilPotions, VeracPrayer, VeracPotions, GuthanPrayer,
			GuthanPotions, ToragPrayer, ToragPotions, AhrimPrayer,
			AhrimPotions;
	private static JComboBox<Magic.Spell> cbxDharok, cbxKaril, cbxVerac,
			cbxGuthan, cbxTorag, cbxAhrim;
	...
	private JTextField txtFood, txtSA, txtSS, txtSD, txtRP, txtPP, txtArrows,
			txtCasts;
	...
	public BarrowGUI() {
		addWindowListener(new WindowAdapter() {
			...
			public void windowOpened(WindowEvent arg0) {
				...
				DharokPrayer.setSelected(!Brother.Brothers.Dharok.getPrayer()
						.equals(Prayer.Prayers.None));
				KarilPrayer.setSelected(!Brother.Brothers.Karil.getPrayer()
						.equals(Prayer.Prayers.None));
				GuthanPrayer.setSelected(!Brother.Brothers.Guthan.getPrayer()
						.equals(Prayer.Prayers.None));
				AhrimPrayer.setSelected(!Brother.Brothers.Ahrim.getPrayer()
						.equals(Prayer.Prayers.None));
				VeracPrayer.setSelected(!Brother.Brothers.Verac.getPrayer()
						.equals(Prayer.Prayers.None));
				ToragPrayer.setSelected(!Brother.Brothers.Torag.getPrayer()
						.equals(Prayer.Prayers.None));
		...
		btnStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Brother.Brothers.Dharok.setUsePotions(DharokPotions
						.isSelected());
				Brother.Brothers.Karil.setUsePotions(KarilPotions.isSelected());
				Brother.Brothers.Verac.setUsePotions(VeracPotions.isSelected());
				Brother.Brothers.Guthan.setUsePotions(GuthanPotions
						.isSelected());
				Brother.Brothers.Torag.setUsePotions(ToragPotions.isSelected());
				Brother.Brothers.Ahrim.setUsePotions(AhrimPotions.isSelected());

				Brother.Brothers.Dharok.setSpell((Magic.Spell) cbxDharok
						.getSelectedItem());
				Brother.Brothers.Karil.setSpell((Magic.Spell) cbxKaril
						.getSelectedItem());
				Brother.Brothers.Verac.setSpell((Magic.Spell) cbxVerac
						.getSelectedItem());
				Brother.Brothers.Guthan.setSpell((Magic.Spell) cbxGuthan
						.getSelectedItem());
				Brother.Brothers.Torag.setSpell((Magic.Spell) cbxTorag
						.getSelectedItem());
				Brother.Brothers.Ahrim.setSpell((Magic.Spell) cbxAhrim
						.getSelectedItem());
		...
		gl_panel_2.setHorizontalGroup(gl_panel_2.createParallelGroup(
				...
				gl_panel_2
						...
						.addGroup(
								gl_panel_2
										.createParallelGroup(Alignment.LEADING)
										.addComponent(cbxBarrows, 0, 215,
												Short.MAX_VALUE)
										.addComponent(cbxBank, 0, 215,
												Short.MAX_VALUE))
						.addContainerGap()));
		gl_panel_2
		...
		btnSetEquipment.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Brother.Brothers.Dharok.setEquipmentIds(Equipment
						.getEquipedItems());
			}
		});
		...
		gl_panelDharok.setHorizontalGroup(gl_panelDharok.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelDharok
						.createSequentialGroup()
						.addContainerGap()
		...
		gl_panelDharok
				.setVerticalGroup(gl_panelDharok
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelDharok
										.createSequentialGroup()
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Brother.Brothers.Karil.setEquipmentIds(Equipment
						.getEquipedItems());
			}
		});
		...
		gl_panelKaril.setHorizontalGroup(gl_panelKaril.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelKaril
						.createSequentialGroup()
						.addContainerGap()
						...
						.addContainerGap(10, Short.MAX_VALUE)));
		gl_panelKaril
				.setVerticalGroup(gl_panelKaril
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelKaril
										.createSequentialGroup()
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Brother.Brothers.Verac.setEquipmentIds(Equipment
						.getEquipedItems());
			}
		});
		...
		gl_panelVerac.setHorizontalGroup(gl_panelVerac.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelVerac
						.createSequentialGroup()
						.addContainerGap()
						...
						.addContainerGap(10, Short.MAX_VALUE)));
		gl_panelVerac
				.setVerticalGroup(gl_panelVerac
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelVerac
										.createSequentialGroup()
		...
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Brother.Brothers.Guthan.setEquipmentIds(Equipment
						.getEquipedItems());
			}
		});
		...
		gl_panelGuthan.setHorizontalGroup(gl_panelGuthan.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelGuthan
						.createSequentialGroup()
						.addContainerGap()
						...
						.addContainerGap(10, Short.MAX_VALUE)));
		gl_panelGuthan
				.setVerticalGroup(gl_panelGuthan
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelGuthan
										.createSequentialGroup()
		...
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Brother.Brothers.Torag.setEquipmentIds(Equipment
						.getEquipedItems());
			}
		});
		...
		gl_panelTorag.setHorizontalGroup(gl_panelTorag.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelTorag
						.createSequentialGroup()
						.addContainerGap()
						...
						.addContainerGap(10, Short.MAX_VALUE)));
		gl_panelTorag
				.setVerticalGroup(gl_panelTorag
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelTorag
										.createSequentialGroup()
		...
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Brother.Brothers.Ahrim.setEquipmentIds(Equipment
						.getEquipedItems());
			}
		});
		...
		gl_panelAhrim.setHorizontalGroup(gl_panelAhrim.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelAhrim
						.createSequentialGroup()
						.addContainerGap()
						...
						.addContainerGap(10, Short.MAX_VALUE)));
		gl_panelAhrim
				.setVerticalGroup(gl_panelAhrim
						.createParallelGroup(Alignment.LEADING)
						.addGroup(
								gl_panelAhrim
										.createSequentialGroup()
		...
		gl_panelTunnels.setHorizontalGroup(gl_panelTunnels.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelTunnels
						.createSequentialGroup()
						.addContainerGap()
						.addComponent(button_5, GroupLayout.PREFERRED_SIZE,
								101, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(180, Short.MAX_VALUE)));
		gl_panelTunnels.setVerticalGroup(gl_panelTunnels.createParallelGroup(
				Alignment.LEADING).addGroup(
				gl_panelTunnels.createSequentialGroup().addContainerGap()
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						...
						.addComponent(listSelected, GroupLayout.PREFERRED_SIZE,
